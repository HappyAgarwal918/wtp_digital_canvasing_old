        ...
        <div class="row">
            <div class="col-md-8">
                <div class="block mb-0 pb-0">
                    ...
                    <button type="submit" name="btn" value="updateAndClose" class="btn btn-primary btn-sm float-left mr-1" form="add-form">Update & Close</button>
                </div>
                <div class="block">
                    <div class="p-3 bg-white">
                        <form action="{{ route('users.update', $item->id) }}" method="post" enctype="multipart/form-data" id="add-form">
                            @csrf
                            @method('PUT')
                            <div class="row pb-3">
                                <div class="col-md-3">
                                    <label for="first_name">First Name</label>
                                    <input type="text" name="first_name" id="first_name" class="form-control form-control-sm {{ $errors->has('first_name') ? 'is-invalid' : '' }}" value="{{ $item->first_name }}">
                                ...
                                <div class="col-md-1">
                                    ...
                                    <input type="text" name="middle_initial" id="middle_initial" class="form-control form-control-sm {{ $errors->has('middle_initial') ? 'is-invalid' : '' }}" value="{{ $item->middle_initial }}" maxlength="2">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="last_name" id="last_name" class="form-control form-control-sm {{ $errors->has('last_name') ? 'is-invalid' : '' }}" value="{{ $item->last_name }}">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" name="birthday" id="birthday" placeholder="mm/dd/yy" class="form-control form-control-sm datepicker {{ $errors->has('birthday') ? 'is-invalid' : null}}" value="{{ $item->birthday }}" autocomplete="off">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="number" oninput="maxLengthCheck(this)" name="last_4_ssn" id="last_4_ssn" class="form-control form-control-sm {{ $errors->has('last_4_ssn') ? 'is-invalid' : '' }}" value="{{ $item->last_4_ssn }}" maxlength="4">
                            ...
                            <div class="row pb-3">
                                <div class="col-md-5">
                                    ...
                                    <input type="text" name="street_address" id="street_address" class="form-control form-control-sm {{ $errors->has('street_address') ? 'is-invalid' : '' }}" value="{{ $item->street_address }}">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="city" id="city" class="form-control form-control-sm {{ $errors->has('city') ? 'is-invalid' : '' }}" value="{{ $item->city }}">
                                    {{-- @if($errors->has('city'))
                                ...
                                <div class="col-md-1 px-0">
                                    ...
                                    <input type="text" name="state" id="state" class="form-control form-control-sm {{ $errors->has('state') ? 'is-invalid' : '' }}" value="{{ $item->state }}">
                                    {{-- @if($errors->has('state'))
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" name="zipcode" id="zipcode" class="form-control form-control-sm {{ $errors->has('zipcode') ? 'is-invalid' : '' }}" value="{{ $item->zipcode }}" maxlength="5" oninput="maxLengthCheck(this)">
                            ...
                            <div class="row pb-3">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="tel" name="phone" id="phone" class="form-control form-control-sm {{ $errors->has('phone') ? 'is-invalid' : '' }}" value="{{ $item->phone }}">
                                    </div>
                                    {{-- @if($errors->has('phone'))
                                ...
                                <div class="col-md-5">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control form-control-sm email {{ $errors->has('email') ? 'is-invalid' : '' }}" value="{{ $item->email }}">
                                    {{-- @if($errors->has('email'))
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="number" name="voter_id" id="voter_id" class="form-control form-control-sm {{ $errors->has('voter_id') ? 'is-invalid' : '' }}" value="{{ $item->voter_id }}" maxlength="7" oninput="maxLengthCheck(this)">
                            ...
                            <div class="row pb-3">
                                <div class="col-md-3">
                                    ...
                                    <select name="approved_by_id" id="approved_by_id" data-width="100%" class="form-control form-control-sm selectpicker {{ $errors->has('approved_by_id')? 'is-invalid' : '' }}" title="Select approved by">
                                        @php($selectedItem = $item->approved_by_id)
                                        @foreach ($item->approved_users as $value)
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select name="manager_id" id="manager_id" data-width="100%" class="form-control form-control-sm selectpicker {{ $errors->has('manager_id')? 'is-invalid' : '' }}" title="Select manager">
                                        @php($selectedItem = $item->manager_id)
                                        @foreach ($item->managers as $value)
                                        <option value="{{ $value->id }}" {{ $value->id ==  $selectedItem ? 'selected' : ''}}>{{ $value->first_name.' '.$value->last_name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" name="username" id="username" class="form-control form-control-sm {{ $errors->has('username') ? 'is-invalid' : '' }}" value="{{ $item->username }}">
                            ...
                            <div class="row pb-3">
                                <div class="col-md-9">
                                    <div class="row">
                                        @foreach ( $item->access_labels as $value)
                                        <div class="col-md-5">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" name="user_label[{{ $value->id }}]" class="custom-control-input" id="user_label_{{ $value->id }}" value="{{ $value->value }}" {{ in_array($value->value,$item->user_label) ? 'checked' : null }}>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        {{-- name="user_label" --}}
                                        <input type="number" id="user_label" class="form-control form-control-sm {{ $errors->has('user_label') ? 'is-invalid' : '' }}" value="{{ $item->user_label_total }}" disabled>
                                    ...
                                    <div class="clearfix">
                                        {{-- <div class="form-check">
                                            <input class="form-check-input" name="inactive" type="checkbox" id="inactive" value="1" {{ $item->inactive == 1 ? 'checked="checked"' : '' }}>
                                        <label class="form-check-label" for="inactive">
                                            Inactive
                                        </label>
                                    </div> --}}
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="inactive" class="custom-control-input" id="inactive" value="1" {{ $item->inactive == 1 ? 'checked="checked"' : '' }}>
                                        <label class="custom-control-label" for="inactive">Inactive</label>
                                    </div>
                                    {{-- @if($errors->has('inactive'))
                                        <small class="form-text text-danger">{{ $errors->first('inactive') }}</small>
                                    @endif --}}
                                </div>
                            </div>
                    </div>
                    ...
                    <div class="row" id="drop-area" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);">
                        <div class="col-md-12">
                            <table class="table table-sm table-bordered" id="selected_files_th">
                                ...
                                @foreach ($saved_storage_data as $saved_storage)
                                    <tr id='saved_storage_data_{{$saved_storage->id}}'>

                                        <td style="width: 70px;">
                                            <div class="d-flex">
                                                <input class="form-control form-control-sm" type="text" value="{{$saved_storage->storage_type}}" readonly>
                                            </div>
                                        </td>
                                        <td><input class="form-control form-control-sm" type="text" name="save_storage_data[{{$saved_storage->id}}]" value="{{$saved_storage->description}}"></td>
                                        <td></td>
                                        <td><a href="{{asset('storage/'.$saved_storage->server_location)}}" target="_blank" class="btn btn-primary btn-sm">View</a></td>
                                    </tr>
                                    {{--@dump($saved_storage)--}}
                                @endforeach
...
<script type="text/javascript">
    ...
    function remove_selected_file(i, tr_id) {
        let selected_fdata_index = selected_files.findIndex((d) => {
            return d.f_number == i;
        });
